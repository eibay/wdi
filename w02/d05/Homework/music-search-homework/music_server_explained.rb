...
# but THIS LINE OF CODE HERE THAT I COPIED FROM PAGES was causing an error
...
# adding LINE OF CODE DIRECTLY FROM HW ASSIGMENT ON GITHUB. 
# SEAN SAYS PAGES MIGHT HAVE BEEN ADDING SOME IMAGINARY CHARACTERS, SYMBOLS OR FORMATTING. SO DON'T PASTE CODE FROM IT NEXT TIME!!!
