...
# puts "#{nums[i]-1} bottles of beer on the wall"
...
#print out login was created at created_at
...
githubs.each do |sumthin| #sumthin is a hash
	puts sumthin["login"] + "was created at" + sumthin ["created_at"]
end
