...
while true
	...
	elsif path == "/gryffindor/bell"
		client.puts File.read("./views/gryffindor/bell.html")
		puts "Sent 'gryffindor_bell.html' to #{client_ip}"
	elsif path == "/gryffindor/patil"
		client.puts File.read("./views/gryffindor/patil.html")
		puts "Sent 'gryffindor_patill.html' to #{client_ip}"
	elsif path == "/slytherin"
		client.puts File.read("./views/slytherin.html")
		puts "Sent 'slytherin.html' to #{client_ip}"
	elsif path == "/slytherin/parkinson"
		client.puts File.read("./views/slytherin/parkinson.html")
		puts "Sent 'slytherin_parkinson.html' to #{client_ip}"
	elsif path == "/slytherin/pike"
		client.puts File.read("./views/slytherin/pike.html")
		puts "Sent 'slytherin_pike.html' to #{client_ip}"
	else
