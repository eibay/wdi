...
#not sure if it would go here but i'm putting it here:

# house 

# student_name.html

# page is actually going to be /house/student_name
...
#means if the path is to the stylesheet - for browser / means folder where your website is index.html
	...
	puts "Sent 'gryffindor.html' to #{client_ip}"#we sent this to the client
elsif path == "/slytherin.html"
	client.puts File.read('/views/slytherin.html')
	puts "Sent 'slytherin.html' to #{client_ip}"#we sent this to the client
elsif path == "house/student_name.html"
	client.puts File.read('/views/student_name.html')
	puts "Sent '/student_name.html' to #{client_ip}"#we sent this to the client
