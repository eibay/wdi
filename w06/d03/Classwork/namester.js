...
var bumblebee=firstnamelist[0]
firstnamelist.push("Peter")

var remove=lastnamelist.indexOf("Muffinmitts")
lastnamelist.splice(remove, 1)
var scratch=lastnamelist.indexOf("Scratchnsniff")
// var first=Math.floor(Math.random() * (firstnamelist.length));
//  first=firstnamelist[first]
//  var last=Math.floor(Math.random() * (lastnamelist.length));
//  last=lastnamelist[last]
