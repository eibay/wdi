...
// 
var index = firstnamelist.indexOf("Bumblebee");

console.log(firstnamelist[index]);

// 
firstnamelist.push("Peter");

// 
var index02 = firstnamelist.indexOf("Muffinmitts");

firstnamelist.splice(index02, 1);

// 
var index03 = lastnamelist.indexOf("Scratchnsniff");

// 

var randFirst = firstnamelist[Math.floor(firstnamelist.length * Math.random())];

var randLast = lastnamelist[Math.floor(lastnamelist.length * Math.random())];

console.log(randFirst + " " + randLast)
