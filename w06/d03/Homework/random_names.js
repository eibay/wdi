...
// get the n of random names to generate 
n = process.argv[2]

// create a randomIndex helper method on Array 
...
function genRandName(){
	var firstName = firstnamelist[firstnamelist.randomIndex()]; 
	var lastName = lastnamelist[lastnamelist.randomIndex()]; 
