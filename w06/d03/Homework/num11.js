...
console.log("i")
var i = firstnamelist.indexOf("Bumblebee")
console.log(i)

console.log("ii")
firstnamelist.push("peter")
console.log(firstnamelist[firstnamelist.length - 1])

console.log("iii")
var iii = firstnamelist.indexOf("Muffinmitts")
var iii2 = firstnamelist.splice(iii, 1);
console.log(firstnamelist)

console.log("iv")
var iv = lastnamelist.indexOf("Scratchnsniff")
console.log(iv)

console.log("v")
var v1 = firstnamelist[Math.floor(Math.random() * firstnamelist.length)]
var v2 = lastnamelist[Math.floor(Math.random() * lastnamelist.length)]
console.log(v1 + " " + v2)

console.log("vi")
var vi = function(firstnamelist, lastnamelist) {var v1 = firstnamelist[Math.floor(Math.random() * firstnamelist.length)]
var v2 = lastnamelist[Math.floor(Math.random() * lastnamelist.length)]
console.log(v1 + " " + v2)}
for (var i=0; i < args[2]; i++){
	vi(firstnamelist, lastnamelist)
}
