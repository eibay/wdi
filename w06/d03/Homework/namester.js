...
function searchName(search, array){
  for (x=0; x<array.length; x++){
    if (array[x] == search) console.log("Found " + search + " at index: " + x);
  }
  console.log('not present.');
};

searchName("Bumblebee", firstnamelist)

console.log("########### Number 2 #############");

firstnamelist.push("Peter", firstnamelist);

console.log("########### Number 3 #############");

searchName("Muffinmitts", firstnamelist);
firstnamelist.splice(8, 1);

console.log("########### Number 4 #############");

searchName("Scratchnsniff", lastnamelist);
// Found Scratchnsniff at index: 25

console.log("########### Number 5 #############");

function randomName(){
  first = firstnamelist[parseInt(Math.random() * firstnamelist.length)];
  last = lastnamelist[parseInt(Math.random() * lastnamelist.length)];
