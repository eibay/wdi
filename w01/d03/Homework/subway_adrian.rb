...
def distance(line, start_stop, end_stop, subway_map)
...
totalstops = distance(begline, begstop, endstop, subway) 
...
first_leg = distance(begline, begstop, "Union_sq", subway) 
second_leg = distance(endline, "Union_sq", endstop, subway) 
