...
if starting_line != ending_line 
	distance = (n.index(matching_element_starting).to_i - n.index(matching_element_ending).to_i).abs 
	
	elsif starting_line != ending_line 
		distance = (l.index(matching_element_starting).to_i - l.index(matching_element_ending).to_i).abs 

		elsif starting_line != ending_line 
			distance = (six.index(matching_element_starting).to_i - six.index(matching_element_ending).to_i
				).abs 
