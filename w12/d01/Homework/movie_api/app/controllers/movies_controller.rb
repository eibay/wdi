class MoviesController < ApplicationController
 ...
 poster_url: params["poster_url"]
  ...
  #Good input
  #HTTParty.put('http://localhost:3000/superheros/1.json', :body => {title: "Love Exposure", year: "2013", poster_url: "http://content7.flixster.com/movie/11/15/93/11159353_800.jpg"})
  #Bad input
  #HTTParty.put('http://localhost:3000/superheros/1.json', :body => {year: "2013"})  
  def update
