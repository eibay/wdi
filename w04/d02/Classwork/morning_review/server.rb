...
get("stduents/search_results") do
  results = Student.select_by(params["search_type"], params["keyword"]) #"search_type" is first because it was first in the student_search erb as the select_name.
