...
get("/shuttles/new") do
  erb(:new_shuttle, {locals: { shuttles: Shuttle.all() }})
end
...
get("/shuttles/:id") do
  ...
  astronauts_inside_shuttle = Astronaut.select_by("shuttle_id", shuttle["id"])


  erb(:shuttle, {locals: {shuttle: shuttle, astronauts: astronauts_inside_shuttle }})
