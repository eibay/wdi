...
get '/posts/:id' do
  ...
  specific_data_images = Image.post("post_id", post_id)
...
# binding.pry
  ...
  specific_data_images = Image.post("post_id", post_id) # this is just another name for select_by.. i don't understand
